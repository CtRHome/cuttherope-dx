...
namespace CutTheRopeDX.GameMain
{
    ...
    internal sealed class GameController : ViewController, IButtonDelegation, IGameSceneDelegate
    {
        ...
        public void BoxClosed()
        {
            ...
            for (int i = 0; i < Preferences.GetLevelsInPackCount(pack); i++)
            {
        ...
        public void LevelWon(LevelResult result)
        {
            ...
            {
                Preferences.SetScoreForPackLevel(box, result.FinalScore, pack, level);
            ...
            {
                Preferences.SetStarsForPackLevel(box, result.StarsCollected, pack, level);
            ...
            else
            {
                ...
                switch (musicPack)
                {
                    ...
                    case var p when p == MusicPackNames.KaizoPackage:
                        SoundMgr.PlayRandomMusic(MusicPacks.KaizoPackage);
                        break;
                    default:
